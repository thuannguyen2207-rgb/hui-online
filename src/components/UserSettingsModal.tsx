                ...
                <div className="sm:col-span-2">
                  <div className="flex items-center justify-between mb-1">
                    ...
                    >
                      ...
                      <span>Gợi Ý / Chọn Theo Tỉnh/Quận/Đường</span>
                    </button>
                  </div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 focus:border-amber-500 rounded-xl pl-3.5 pr-24 py-2.5 text-slate-200 text-xs focus:outline-none"
                    />
                    <button
                      type="button"
                      onClick={() => setIsAddressPickerOpen(true)}
                  ...
                  <div className="mt-1.5 flex flex-wrap items-center gap-1">
                    <span className="text-[10px] text-slate-500">Mẫu địa chỉ:</span>
                    {QUICK_PRESET_ADDRESSES.slice(0, 3).map((preset, pIdx) => (
                      <button
                        key={pIdx}
                        type="button"
                        onClick={() => setAddress(preset)}
                        className="px-2 py-0.5 bg-slate-950 hover:bg-slate-800 border border-slate-800 rounded-md text-[10px] text-slate-400 hover:text-amber-300 truncate max-w-[200px] transition-all"
                      >
                        {preset}
                      </button>
                    ))}
