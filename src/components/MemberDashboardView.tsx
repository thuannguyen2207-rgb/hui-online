      ...
      <div className="bg-gradient-to-r from-slate-900 via-slate-900 to-blue-950/40 border border-blue-500/30 rounded-2xl p-5 sm:p-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 shrink-0">
            ...
            <div className="bg-slate-950/80 p-3.5 rounded-xl border border-slate-800 flex items-center space-x-2">
              <input
                type="text"
                readOnly
                value={getInviteUrl()}
                onClick={handleCopyLink}
                className="bg-slate-900 border border-slate-800 rounded-lg px-2.5 py-1.5 text-[11px] text-amber-300 font-mono truncate w-36 sm:w-44 cursor-pointer select-all"
              />
              <button
                onClick={handleCopyLink}
                title="Sao chép link mời hội viên"
